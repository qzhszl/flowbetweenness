function [wtildes,rtildes,optErrs,Aerrs] = effResGDSmallSerial(r, Ltrue, lambda, w0, iters, degreeConst, method )
% Serial execution adapter for the preserved effResGDSmall implementation.
% The numerical algorithm is unchanged; only the line-search parfor is
% executed as a regular for loop to avoid nested pools under SLURM.
