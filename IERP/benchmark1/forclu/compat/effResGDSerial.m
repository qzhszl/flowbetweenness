function [wtildes,rtildes,optErrs,Aerrs] = effResGDSerial(r, u,v, Ltrue, lambda, w0, iters, degreeConst, batchSize, method )
% Serial execution adapter for the preserved effResGD implementation.
% The numerical algorithm is unchanged; only the resistance-update parfor
% is executed as a regular for loop to avoid nested pools under SLURM.
