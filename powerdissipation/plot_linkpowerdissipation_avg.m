...
plot(avg_vec,ave_link_power_vec,"-o",'LineWidth', 4, 'MarkerSize', 12,color = "#D08082")
hold on
...
picname = sprintf("D:\\data\\flow betweenness\\power_dissipation\\link_power_distribution_N%d_withdiffavg.pdf",n);
