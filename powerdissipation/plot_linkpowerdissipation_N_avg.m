...
hold off
if weigthed_flag ==1
    picname = sprintf("D:\\data\\flow betweenness\\power_dissipation\\link_power_distribution_p%.2f_withdiffN_avg.pdf",p);
else
    picname = sprintf("D:\\data\\flow betweenness\\power_dissipation\\link_power_distribution_p%.2f_withdiffN_unweighted_avg.pdf",p);
end
