...
hold off
if weigthed_flag==0
    picname = sprintf("D:\\data\\flow betweenness\\power_dissipation\\link_power_distribution_N%d_m%d_unweighted.pdf",n,m);
else
    picname = sprintf("D:\\data\\flow betweenness\\power_dissipation\\link_power_distribution_N%d_m%d.pdf",n,m);
end
