function compute_power_dissipation_eachlink_BA()
...
for k = 1:simu_times
    ...
    n=5000;
    m=3;
    networkname = sprintf('BAnetworkN%dm%d.txt',n,m);
    data = readmatrix(networkname);  % 每行: u v w
...
filename = sprintf('power_dissipation_N%dm%d.mat',n,m);
% 保存到文件
